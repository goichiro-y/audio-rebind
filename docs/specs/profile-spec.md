...
- `delays.afterAudioEngineMs` is profile-driven (loader default / example **2000**). On hosts where endpoints reappear quickly, **500–1000** can cut wall-clock; if playback/capture is flaky after resume, raise it again ([#20](https://github.com/goichiro-y/audio-rebind/issues/20)).
