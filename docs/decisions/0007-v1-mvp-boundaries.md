...
**Version ladder** (do not rename catalog work to “V3”): **0.1.x** = this MVP; **0.x** = public-prep polish; **1.0.0** = strangers-can-follow-README; **V2** = catalog / GUI (Later). See [ROADMAP.md](../../ROADMAP.md).
