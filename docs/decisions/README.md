...
| [0005-resume-trigger-task-scheduler.md](0005-resume-trigger-task-scheduler.md) | Task Scheduler + elevated task; Power-Troubleshooter/1 |
...
| [0007-v1-mvp-boundaries.md](0007-v1-mvp-boundaries.md) | V1 MVP: explicit profile, no GUI, no always-on agent |
